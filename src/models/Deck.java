...
/**
 * The Deck class represents the deck of cards used during a round
 * of Memory Game. Each Deck object has an associated theme and
 * difficulty, which are selected by the user before the game begins.
 */
public class Deck {
	...
	/**
	 * The constructor for Deck class assigns the user selected theme
	 * and difficulty mode to the appopriate variables.
	 * 
	...
	/**
	 * createDeck() uses the slected theme and difficulty to build the
	 * approriate deck of cards for the game. The selectable themes are
	 * Cat, Car, and Galaxy. The selectable difficulties are easy and hard.
	 * An easy difficulty means that the deck will be created with 6 cards,
	 * each with a picture that corresponds to the theme. A deck created with 
	 * the hard difficulty will be created with 12 cards. 
	 * 
	 ...
	 * in the deck. This method is used before each round of
	 * Memory Game to ensure that the location of matching cards
	 * isn't predictable.
	 */
    public void shuffle() {
